...
// expand the file to include the properties.
$options = array(
  'return_array' => 1,
  'order_by' => array('rank' => 'ASC'),
);
$file = chado_expand_var($file,'table', 'fileprop', $options);
$fileprops = $file->fileprop;
$properties = array();

if (count($properties)) { ?>
  <div class="tripal_file-data-block-desc tripal-data-block-desc">Additional details for this file include:</div> <?php 
  ...
  $table = array(
    ...
    'rows' => $rows,
    'attributes' => array(
      'id' => 'tripal_file-table-properties',
